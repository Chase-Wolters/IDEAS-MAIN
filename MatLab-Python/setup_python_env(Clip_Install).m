...
if useVirtualEnv
    ...
    venvPath = "C:\Users\cwolt\PycharmProjects\IDEAS\.venv1";  % Path to virtual environment
...
requiredPackages = {'torch', 'torchvision', 'numpy', 'scipy', 'matplotlib' 'ftfy', 'regex'}; % added ftfy, regex
